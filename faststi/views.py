...
class FaststiFormView(JobFormView):
    ...
    def _write_initial_gen(self, f, fields):
        f.write("sex;sex_preferred;age|5-YEAR;1\n")
        f.write("0;0;0;0.0\n")
        f.write("0;0;1;0.0\n")
        f.write("0;0;2;0.0\n")
        j = 3
        for i in range(7):
            f.write(f"0;0;{j};{fields[i]}\n")
            j = j + 1
        f.write("0;1;0;0.0\n")
        f.write("0;1;1;0.0\n")
        f.write("0;1;2;0.0\n")
    ...
    def write_config_file(self, data, files, key):
        ...
        initial_infections_filename = \
                os.path.join(DATA_DIR, f"initial_infections_{key}.csv")
        ...
        with open(filename, 'w') as f:
            ...
            for k in filter(lambda x: x.startswith("a_") or
                ...
                f.write(f'{o} = {val}\n')
            f.write(f"dataset_gen_infect = initial_infections_{key}.csv\n")
